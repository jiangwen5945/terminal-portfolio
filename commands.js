const portfolioAPI = `https://bolfphus.api.sanity.io/v2025-07-05/data/query/production?query=*[_type == "personal"] {
  "roles": roles,
  "about": about,
  "email": email,
  "skills": *[ _type == "skills"] {
...
const website = "https://jiangwen.site";
